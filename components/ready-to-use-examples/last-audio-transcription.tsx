...
export function LastAudioTranscription({
  onDataChange,
}: {
        ...
        <div className="flex flex-col text-slate-600">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <span>
                {audioData.speaker?.name ||
                  `ID: ${audioData.speaker?.id || "Unknown"}`}
              </span>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <Button onClick={fetchLatestAudio} disabled={isLoading} size="sm">
          {isLoading ? (
            <>
        ...
        {audioData && (
          <Button
            ...
            size="sm"
            onClick={() =>
              navigator.clipboard.writeText(audioData.transcription)
            }
          >
            Copy
          </Button>
